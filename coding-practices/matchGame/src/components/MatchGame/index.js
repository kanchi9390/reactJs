...
class MatchGame extends Component {
  ...
  render() {
    const {activeTabId, index, score, isGameOver, time} = this.state
          ...
          {isGameOver ? (
            <div className="game-over-card">
              <img
                ...
                className="trophy"
              />
              <p className="final-heading">YOUR SCORE</p>
              <h1 className="final-heading">{score}</h1>
              <button
                type="button"
            ...
            <>
              ...
              <ul className="images-list">
                {filteredImageList.map(eachImg => (
                  <ImageItem
                    key={eachImg.id}
                    imageDetails={eachImg}
                    onImageItem={this.onImageItem}
                  />
                ))}
              </ul>
            </>
