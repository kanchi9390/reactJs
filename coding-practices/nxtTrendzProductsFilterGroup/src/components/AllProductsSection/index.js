...
class AllProductsSection extends Component {
  state = {
    productsList: [],
    activeState: activeStateConstants.initial,
  ...
  getProducts = async () => {
    this.setState({
      activeState: activeStateConstants.loading,
    })
    ...
    if (response.ok) {
      ...
      this.setState({
        ...
        activeState: activeStateConstants.success,
      })
    } else {
      this.setState({activeState: activeStateConstants.failure})
    }
  }
  ...
  renderNoProducts = () => (
    <div className="failure-container">
      ...
      />
      <h1 className="failure-h">No Products Found</h1>
  ...
  renderProductsList = () => {
    ...
    const isProducts = productsList.length > 0
    if (isProducts) {
      return (
